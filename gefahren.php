...
<p>Fuchs, Dachs und Uhu zählen zu den natürlichen Feinden des Igels.</p>
...
<p>Auch wir haben bereits live erleben dürfen, wie solche Verletzungen aussehen:
	<figure>
		<figcaption>
			Juri kam zu uns, nachdem ihm mit einem Fadenschneider die Haut von der Stirn rasiert wurde.
			Innerhalb kürzester Zeit war der Bereich um die Wunde voller Fliegeneier:
		</figcaption>
		<label for="juri-1" class="veil">
			<input type="checkbox" id="juri-1" autocomplete="off"/>Hier klicken zum Ansehen.
			<div class="clip">
				<img alt="Igel Juri voller Fliegeneier" src="media/2020-05-31-100543_004.jpg" width="990" height="660">
			</div>
		</label>
	</figure>
	...
	<figure>
		...
		<label for="juri-2" class="veil">
			<input type="checkbox" id="juri-2" autocomplete="off">
			Hier klicken zum Ansehen.
			<div class="clip">
				<img alt="Igel Juri mit offener Stirnwunde" src="media/2020-05-30-22-52-35-2643.jpg" width="990" height="660">
			</div>
		</label>
	</figure>
	...
	<figure>
		...
		<label for="juri-3" class="veil">
			<input type="checkbox" id="juri-3" autocomplete="off"/>
			Hier klicken zum Ansehen.
			<div class="clip">
				<img alt="Igel Juri mit offener Wunde an der Wange" src="media/2020-06-12-230653_001.jpg" width="990" height="660">
			</div>
		</label>
	</figure>
	...
	<figure>
		...
		<label for="helsinki" class="veil">
			<input type="checkbox" id="helsinki" autocomplete="off"/>
			Hier klicken zum Ansehen.
			<div class="clip">
				<img alt="Offene Wunde, bereits voller Eiter" src="media/IMG_20220603_211327.jpg" width="990" height="660">
			</div>
		</label>
	</figure>
</p>
