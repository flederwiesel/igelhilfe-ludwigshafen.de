...
<dd>Ist der Igel unterkühlt muss sofort Wärme zugeführt werden, da der Igel bei schwachem Kreislauf die Körperwärme selbst nicht mehr produzieren kann. Die Wärmflasche oder das Wärmekissen mit einem Handtuch umwickeln, darauf den Igel setzen. Behelfsweise geht auch ein Gummihandschuh oder eine Flasche, die man mit warmem Wasser füllt. Es reicht nicht aus, unterkühlte Igel in die Sonne zu setzen! Diese Wärme reicht nicht aus, um die Körpertemperatur auf 36 °C zu bringen bzw. zu halten!</dd>

<dt>Wasser bereitstellen, keine Milch!</dt>
<dd>
	<div>Fundigel sind oft dehydriert und schwach, deshalb sind Wasser und Elektrolyte wichtig. Bei sehr schwachen Igeln muss der Kreislauf evtl. mit Zucker angekurbelt werden, deshalb ist hier Zuckerwasser oder Cola (bitte ohne Kohlensäure) ratsam. Alternativ kann man auch versuchen, etwas Honig unter die Zunge zu schmieren.</div>
	<div>Da Igel sehr laktoseintolerant sind, dürfen sie keine Milch bekommen.</div>
</dd>

<dt>Fliegeneier und Maden absammeln</dt>
<dd>
	<div>Bei warmem Wetter legen Fliegen Eier auf hilflose Tiere, aus denen ja nach Temperatur bereits nach ca. 24h Maden schlüpfen, die den Igel bei lebendigem Leib auffressen, wenn ihnen kein Einhalt geboten wird. Unbedingt alle Maden und Eier zügig absammeln (wird der Igel gewärmt, schlüpfen auch Maden früher)!</div>
	<div>Absammeln der Eier und Maden stresst den Igel sehr, deshalb schwachen Igeln auch mal eine Pause lassen. Unbedingt sämtliche Körperöffnungen kontrollieren, da Maden hier gern hineinkriechen. Auch Eier werden gern in Augen, Ohren, nahe After und Genitalien sowie tief in das Bauchfell oder unter die Achseln gelegt.</div>
	<div>Als „Werkzeug" empfehlen sich der Läusekamm, eine alte Zahnbürste, Maskarabürste und Pinzette. Gegen die Maden kann (außer In den Augen) Jod eingesetzt werden.</div>
</dd>

<dt>Füttern erst bei Erreichen der normalen Körpertemperatur (36°C, handwarm)</dt>
<dd>Wird der unterkühlte Igel gefüttert, kann dies zum Kreislaufkollaps führen.</dd>

<dt>Extrem ausgehungerte Igel sehr sparsam füttern</dt>
<dd>Hat der Igel über mehrere Wochen kein Futter gefunden, kann eine zu schnelle Futteraufnahme bzw. zu große Menge aufgrund der im Körper umgestellten Stoffwechselprozesse und verschobenem Elektrolythaushalt zum Tod des Igels führen (Refeeding-Syndrom). Unterernährte Igel sind immer ein Fall für professionelle Hilfe.</dd>

<dt>Als Futter Katzen- oder Hundefutter (nass oder trocken), Rührei, oder gegartes Rinderhack geben.</dt>
...
<dd>Einstreu ist sehr staubig und verklebt die Nase, das wichtigste Sinnesorgan des Igels. Zeitungspapier ist hier die hygienischere (und praktischere) Unterlage. Zur richtigen Hygiene gehört eine tägliche Reinigung des Igelgeheges, bei Befall mit einzelligen Parasiten auch die Desinfektion.</dd>

<dt>Schlafhaus (Karton) mit Zeitungsschnipseln oder Handtuchhöhle als Unterschlupf</dt>
<dd>
	<div>Selbstverständlich benötigen auch Igel einen Rückzugsort, an dem sie ungestört schlafen, dösen oder sich verstecken können.</div>
	<div>Es kann hier eine Handtuchhöhle oder auch ein Schlafhaus aus Karton, welches mit Zeitungsschnipseln ausgepolstert ist, verwendet werden. Dies muss bei Verschmutzung ausgetauscht werden.</div>
</dd>

<dt>Kotproben zur späteren Analyse sammeln (in luftdicht verschließbarem Gefäß)</dt>
<dd>Damit der Ursache der Erkrankung auf den Grund gegangen werden kann, ist oftmals eine Kotanalyse notwendig. Nur so kann bestimmt werden, ob und welche Parasiten dem Igel zu schaffen machen und wie dagegen behandelt werden muss. Dafür muss frischer Kot von drei aufeinanderfolgenden Tagen gesammelt werden. Wichtig hierbei ist, dass die Probe nicht austrocknet, da einige Parasiten ansonsten schwerer oder gar nicht mehr gefunden werden können. Deshalb bitte die Probe luftdicht verschließen, anhaftendes Zeitungspapier, Zewa o.ä. entfernen. Zur Analyse der Probe im Labor bitte mit einem igelkundigen Tierarzt oder einer Igelstation in Verbindung setzen. Auch wenn die Schnellmethode beim Tierarzt schneller und billiger ist, sollte die Kotanalyse vom Labor durchgeführt werden, da dieses die größere Sachkunde besitzt und nicht alle Tierärzte die Igelparasiten richtig erkennen können -insbesondere bei der Schnellmethode, die nicht alle Parasiten findet.</dd>
</p>
